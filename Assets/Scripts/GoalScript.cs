...
public class GoalScript : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (gameManager == null)
            Debug.LogWarning("GoalScript: GameManager not assigned in inspector and GameManager.Instance is null. Assign via inspector or ensure GameManager sets Instance in Awake.");
    }
